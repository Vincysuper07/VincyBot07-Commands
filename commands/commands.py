...
class VincyBot07e(commands.Cog):
      ...
      async def commands(self,ctx):
            ...
            embed3 = discord.Embed(title="Moderation", description=f"{ctx.prefix}purge <number> - Deletes an amount of messages\n{ctx.prefix}kick <someone> - Kicks someone\n{ctx.prefix}mute <someone> - Mutes someone\n{ctx.prefix}unmute <someone> - Unmute someone\n{ctx.prefix}nuke - Deletes **every** message\n{ctx.prefix}ban <someone> - Ban someone (this is permanent ban)\n{ctx.prefix}unban <someone> - Unbans someone", color = discord.Color.green())
