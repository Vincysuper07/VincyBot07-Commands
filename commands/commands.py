...
class VincyBot07e(commands.Cog):
      ...
      async def mcstatus(self, ctx):
            ...
            response = await self.bot.session.get("http://statomc.vincysuper07.cf/enapi.php")
